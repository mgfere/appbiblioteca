...
<div class="container main--content">
    <div class="header--wrapper">
        <div class="header--title">
          ...
          echo 'Administrador';
            ...
            <h2>Escanear Libro para Préstamo Presencial Docente</h2>
        </div>
    ...
    <div class="tabular--wrapper">
        ...
        <div class="btn-volver-wrapper">
            <a href="panel-docentes.php" class="btn-volver">
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            success: function(response) {
                if (response.success) {
                    if (response.action === 'redirect') {
                        ...
                        window.location.href = `prestamos/registrar-prestamo-docente.php?bookId=${response.bookId}&usuarioId=${userId}`;
    ...
    const displayBookSelector = (libros) => {
        ...
        btnContinuar.onclick = () => {
            ...
            if (selectedId) {
                window.location.href = `prestamos/registrar-prestamo-docente.php?bookId=${selectedId}&usuarioId=${userId}`;
            } else {
