...
<div class="container main--content">
    <div class="header--wrapper">
        <div class="header--title">
          ...
          echo 'Administrador';
            ...
            <h2>Escanear Libro para Préstamo Presencial-Externo</h2>
        </div>
    ...
    <div class="tabular--wrapper">
        ...
        <div class="btn-volver-wrapper">
            <a href="panel-prestamos-presenciales.php" class="btn-volver">
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    if (response.action === 'redirect') {
                        ...
                        window.location.href = 'prestamos/registrar-prestamo.php?bookId=' + response.bookId;
    ...
    const displayBookSelector = (libros) => {
        ...
        btnContinuar.onclick = () => {
            ...
            if (selectedId) {
                window.location.href = 'prestamos/registrar-prestamo.php?bookId=' + selectedId;
            } else {
