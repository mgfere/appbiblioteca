...
if (!$usuarioId || !filter_var($usuarioId, FILTER_VALIDATE_INT)) {
...
<div class="container main--content">
    <div class="header--wrapper">
        <div class="header--title">
          ...
          echo 'Administrador';
            ...
            <h2>Escanear Libro para Préstamo Presencial Usuario-interno</h2>
        </div>
    ...
    <div class="tabular--wrapper">
        ...
        <div class="btn-volver-wrapper">
            <a href="panel-usuarios.php" class="btn-volver">
...
document.addEventListener('DOMContentLoaded', function() {
    const userId = <?php echo json_encode($usuarioId ?? null); ?>;

    if (!userId) {
        Swal.fire("Error Crítico", "No se pudo obtener el ID del usuario. Por favor, vuelve a intentarlo.", "error");
        return;
    }
            ...
            success: function(response) {
                if (response.success) {
                    if (response.action === 'redirect') {
                        ...
                        window.location.href = `prestamos/registrar-prestamo-interno.php?bookId=${response.bookId}&usuarioId=${userId}`;
    ...
    const displayBookSelector = (libros) => {
        ...
        btnContinuar.onclick = () => {
            ...
            if (selectedId) {
                window.location.href = `prestamos/registrar-prestamo-interno.php?bookId=${selectedId}&usuarioId=${userId}`;
            } else {
