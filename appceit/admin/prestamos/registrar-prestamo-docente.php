...
$querySecciones = "SELECT id, nombre_seccion FROM secciones ORDER BY nombre_seccion";
$resultadoSecciones = mysqli_query($db, $querySecciones);
...
if ($bookId) {
    ...
    if ($libro = mysqli_fetch_assoc($resultadoLibro)) {
        ...
        // Debug - añadir esto temporalmente para verificar
...
// --- CONSULTAR DOCENTES DESDE SQL SERVER ---
...
// Variables del usuario - CORREGIDAS
$nombreCompleto = trim($usuario['Nombre'] . ' ' . $usuario['ApellidoPaterno'] . ' ' . $usuario['ApellidoMaterno']);
$matricula = $usuario['Matricula'];
$email = $usuario['CorreoElectronico'] ?? 'No disponible';
$numeroEmpleado = $usuario['NumeroEmpleado'] ?? 'N/A';
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($libroId > 0) {
        ...
        if ($libroValidado = mysqli_fetch_assoc($resultadoVerificarLibro)) {
            ...
            // Debug
            error_log("Validando libro - ID: $libroId, Status: " . $libroValidado['status'] . ", Cantidad disponible: " . $libroValidado['cantidad']);
    ...
    // Verificar si el docente ya tiene 2 préstamos activos
    ...
    if (!array_filter($errores)) {
        ...
        try {
            // ✅ MODIFICADO: Insertar el préstamo CON MATRÍCULA
          // ✅ CORREGIDO: Insertar el préstamo CON MATRÍCULA
...
// ✅ CORREGIDO: 'ssiisis' (7 parámetros, no 8)
                    ...
                    <body>
                        <div class='container'>
                            ...
                            <div class='content'>
                                ...
                                <p><strong>Número de empleado:</strong> $numeroEmpleado</p>
    ...
    <div class="tabular--wrapper">
        ...
        <div class="table--container">
            <form class="book-form" method="POST" enctype="multipart/form-data">
                <h1>Registro de préstamo - Docente</h1>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="numeroEmpleado" name="numeroEmpleado"
                            value="<?php echo htmlspecialchars($numeroEmpleado); ?>" readonly>
                    </div>
                ...
                <button type="submit" class="btnAceptado"
                    ...
                    <i class="fas fa-save" style="margin-right: 5px;"></i>Registrar Préstamo
                </button>
            </form>
        </div>
    </div>
